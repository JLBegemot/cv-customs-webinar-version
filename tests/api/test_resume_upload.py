...
Стенд — SQLite-in-memory + fake-S3 (словарь в памяти). Upload валидирует
формат по magic-байтам, кладёт блоб в S3 и возвращает метаданные. PDF-байты собираются руками (sniff
